...
Weitere Informationen hierzu finden erhalten Sie vom Anbieter unter folgendem Link:
...
E-Mail: privacy (at) kuebler-it (punkt) de
...
Der Webseitenbetreiber hat ein berechtigtes Interesse an der Speicherung von notwendigen Cookies zur
...
können eine von Ihnen erteilte Einwilligung jederzeit widerrufen. Dazu reicht eine formlose Mitteilung per EMail an uns. Die Rechtmäßigkeit der bereits erfolgten Datenverarbeitungsvorgänge bleibt vom Widerruf
unberührt.
